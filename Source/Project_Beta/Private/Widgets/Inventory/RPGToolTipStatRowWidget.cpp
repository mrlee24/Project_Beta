...
FText URPGToolTipStatRowWidget::GetComparisonValue() const
{
	const float LocalValue = ItemStat.Value - ComparisonValue;
	FText ResultText;
...
FSlateColor URPGToolTipStatRowWidget::GetComparisonColor() const
{
	FSlateColor ResultColor;

	if (ItemStat.Value > ComparisonValue)
	{
